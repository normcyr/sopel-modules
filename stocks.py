...
'''
stocks.py - sopel module to fetch stock prices

Outputs the Dow Jones index average, or search your own favourite
stocks! Info comes from finance.google.com, and has a 15 minute stocks delay.

source: https://github.com/dasu/syrup-sopel-modules
author: dasu <https://github.com/dasu>

in beta: need to adapt the output
'''
